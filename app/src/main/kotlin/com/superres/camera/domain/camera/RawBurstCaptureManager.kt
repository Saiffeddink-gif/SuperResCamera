package com.superres.camera.domain.camera
...
import com.superres.camera.data.models.BurstFrame
import com.superres.camera.data.models.BurstSequence
import java.nio.ByteBuffer
import kotlin.math.abs

/**
 * معالج التقاط صور RAW Burst متعددة التعريضات
 */
class RawBurstCaptureManager(private val context: Context) {
    ...
    /**
     * ابدأ التقاط Burst بتعريضات مختلفة
     */
    ...
    /**
     * حساب وقت التعريض بناءً على قيمة التعويض
     */
    private fun calculateExposureTime(exposureCompensation: Float): Long {
        val baseTime = 33_000_000L // 33ms baseline
